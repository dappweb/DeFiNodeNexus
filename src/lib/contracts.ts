...
export const NEXUS_ABI = [
  ...
  "function batchRegisterNftaPurchase(address user, uint256 tierId, uint256 quantity, address referrer) external returns (uint256, uint256)",
  ...
  "function setWithdrawFeeBps(uint256 feeBps) external",
  ...
  "function getDirectChildren(address referrer) view returns (address[])",
  "function getDirectChildrenPage(address referrer, uint256 offset, uint256 limit) view returns (address[])",
  "function getDirectChildrenCount(address referrer) view returns (uint256)",
  "function syncDirectChildren(address referrer, address[] children, bool clearExisting) external",
  ...
  "function setManagers(address[] accounts_, bool[] enabled_) external",
  "function getManagerCount() view returns (uint256)",
  "function getManagerAt(uint256 index) view returns (address)",
  "function getManagers(uint256 offset, uint256 limit) view returns (address[])",
  "function isManagerAddress(address account) view returns (bool)",
...
export const SWAP_ABI = [
  ...
  "function deflationPool() view returns (uint256)",
